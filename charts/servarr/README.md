...
| `jellyfin.image.tag`                            | The image tag to use.                                                                                                                      | `version-10.11.3ubu2404`       |
| `jellyfin.image.pullPolicy`                     | The logic of image pulling.                                                                                                                | `IfNotPresent`                 |
| `jellyfin.imagePullSecrets`                     | The image pull secrets to use.                                                                                                             | `[]`                           |
...
| `jellyfin.tailscale.ingress.enabled`            | Whether to enable ingress mode. Requires the tailscale operator to be preinstalled.                                                        | `false`                        |
...
| `sonarr.image.tag`                                     | The image tag to use.                                                                                                               | `version-4.0.16.2944`        |
...
| `qbittorrent.image.tag`                                     | The image tag to use.                                                                                                               | `version-5.1.4-r0`                |
...
| `prowlarr.image.tag`                                     | The image tag to use.                                                                                                               | `version-2.3.0.5236`           |
...
| `bazarr.image.tag`                                     | The image tag to use.                                                                                                               | `version-v1.5.3`             |
...
| `radarr.image.tag`                                     | The image tag to use.                                                                                                               | `version-6.0.4.10291`        |
...
| `lidarr.image.tag`                                     | The image tag to use.                                                                                                               | `version-3.1.0.4875`         |
